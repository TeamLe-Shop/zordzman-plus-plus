...
std::string CharacterComponent::getComponentName() { return "character"; }

std::string CharacterComponent::getName() { return "character"; }

Component * CharacterComponent::new_() { return new CharacterComponent(); }
