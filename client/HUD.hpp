...
namespace client {
/// The HUD. This contains various variables
///        for how to render the HUD.
class HUD {
public:
    /// Load a HUD file. HUD files are always in json.
    ///
...
public:
    ...
    /// The normal font color used. By default, it is gray.
    uint32_t font_color = 0xB2B2B2FF;

    /// The box usually containing the HUD.
    ///
    ...
    /// The border meant to seperate the HUD from the
    ///        actual gameplay.
    ///
